...
Router.route('/shop/:id').get(func.singleProd).post(func.isUser, func.addProduct).patch(func.isUser, func.loveProduct).put(func.isUser, func.updateCart).delete(func.isUser, func.removeProduct)
